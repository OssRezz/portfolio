  ...
  return (
    <>
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies tecnologies shadow-sm  border-0">
      ...
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          <Card.Body className="d-flex justify-content-center align-items-center pb-0">
      ...
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          ...
          <Card.Footer className="bg-white text-center border-0  text-secondary">Jquery</Card.Footer>
        </Card>
      </Col>
      ...
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          <Card.Body className="d-flex justify-content-center align-items-center pb-0">
            <img src={pythonImg} style={{ height: 70 }} alt="..." />
          </Card.Body>
          <Card.Footer className="bg-white text-center border-0  text-secondary">
            <div style={{ whiteSpace: "nowrap" }}>Python</div>
          </Card.Footer>
        </Card>
      </Col>
      ...
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          <Card.Body className="d-flex justify-content-center align-items-center pb-0">
            <img src={djangoImg} style={{ height: 40 }} alt="..." />
          </Card.Body>
          <Card.Footer className="bg-white text-center border-0  text-secondary">
            <div style={{ whiteSpace: "nowrap" }}>Django</div>
          </Card.Footer>
        </Card>
      </Col>
      ...
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          ...
          <Card.Footer className="bg-white text-center border-0  text-secondary">vba</Card.Footer>
        </Card>
      </Col>
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          ...
          <Card.Footer className="bg-white text-center border-0  text-secondary">MySQL</Card.Footer>
        </Card>
      </Col>
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          ...
          <Card.Footer className="bg-white text-center border-0  text-secondary">Bootstrap</Card.Footer>
        </Card>
      </Col>
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          ...
          <Card.Footer className="bg-white text-center border-0  text-secondary">CSS</Card.Footer>
        </Card>
      </Col>
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          ...
          <Card.Footer className="bg-white text-center border-0  text-secondary">HTML</Card.Footer>
        </Card>
      </Col>
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          ...
          <Card.Footer className="bg-white text-center border-0  text-secondary">Git</Card.Footer>
        </Card>
      </Col>
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          ...
          <Card.Footer className="bg-white text-center border-0  text-secondary">Linux</Card.Footer>
        </Card>
      </Col>
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          <Card.Body className="d-flex justify-content-center align-items-center pb-0">
            <img src={dockerImg} style={{ height: 70 }} alt="..." />
          </Card.Body>
          <Card.Footer className="bg-white text-center border-0  text-secondary">Docker</Card.Footer>
        </Card>
      </Col>
      <Col className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center mb-5">
        <Card style={{ width: "10em" }} className="tecnologies shadow-sm  border-0">
          ...
          <Card.Footer className="bg-white text-center border-0  text-secondary">Scrum / Agile</Card.Footer>
        </Card>
      </Col>
    </>
  );
